package elocindev.resistance_balancer.math;

import elocindev.resistance_balancer.ResistanceBalancer;
...
public class FormulaParser {
    public static double evaluateFormula(String formula) {
        try {
            ...
            ResistanceBalancer.LOGGER.error("Error parsing formula: " + formula);
            return 0;
        }
    }
}
